...
filename = '/home/valeryozenne/mount/Imagerie/For_Valery/TP_reco/FID/meas_MID00029_FID04588_gre_grappa2_with_phase.h5'
filename_noise = '/home/valeryozenne/mount/Imagerie/For_Valery/TP_reco/FID/meas_MID00029_NOISE04588_gre_grappa2_with_phase.h5'
...
figure(9)
for c = 1:nCoils
    subplot(1,nCoils,c); imagesc(abs(mat.image.remove_oversampling(:,:,c))./mat.image.magnitude.sos, [0 1]); %colormap(gray);
end
...
figure(10)
subplot(131); imagesc(sp)



nb_ok_coil_to_keep=nCoils;

[mat.image.grappa.wash_pd] = ismrm_cartesian_GRAPPA(mat.kspace.remove_oversampling(:,:,1:nb_ok_coil_to_keep),sp,2);

[mat.image.grappa.wash] = ismrm_cartesian_GRAPPA(mat.kspace.remove_oversampling(:,:,1:nb_ok_coil_to_keep),sp,2);

[mat.image.grappa.wash_kellman] = ismrm_cartesian_GRAPPA_val(mat.kspace.remove_oversampling(:,:,1:nb_ok_coil_to_keep),sp,2, [], [] , 1);

[mat.image.grappa.wash_python] = ismrm_cartesian_GRAPPA_val(mat.kspace.remove_oversampling(:,:,1:nb_ok_coil_to_keep),sp,2, [], [] , 2);

[mat.image.grappa.inati_iter_python] = ismrm_cartesian_GRAPPA_val(mat.kspace.remove_oversampling(:,:,1:nb_ok_coil_to_keep),sp,2, [], [] , 3);

[mat.image.grappa.inati_gt] = ismrm_cartesian_GRAPPA_val(mat.kspace.remove_oversampling(:,:,1:nb_ok_coil_to_keep),sp,2, [], [] , 4);

[mat.image.grappa.inati_matlab] = ismrm_cartesian_GRAPPA_val(mat.kspace.remove_oversampling(:,:,1:nb_ok_coil_to_keep),sp,2, [], [] , 3);

m_siemens=dicomread('/home/valeryozenne/mount/Imagerie/For_Valery/TP_reco/TEST_TP_RECO_24_11_27-11_47_03-STD-1_3_12_2_1107_5_2_41_169540/COEUR_MORPHOLOGIE_20241127_115106_181000/GRE_GRAPPA2_WITH_PHASE_0006/TEST_TP_RECO.MR.COEUR_MORPHOLOGIE.0006.0001.2024.11.27.12.37.10.15707.39046231.IMA')
p_siemens=dicomread('/home/valeryozenne/mount/Imagerie/For_Valery/TP_reco/TEST_TP_RECO_24_11_27-11_47_03-STD-1_3_12_2_1107_5_2_41_169540/COEUR_MORPHOLOGIE_20241127_115106_181000/GRE_GRAPPA2_WITH_PHASE_0007/TEST_TP_RECO.MR.COEUR_MORPHOLOGIE.0007.0001.2024.11.27.12.37.10.15707.39046265.IMA')


figure()
subplot(2,5,1);  imagesc(abs(mat.image.grappa.wash_kellman));
subplot(2,5,2);  imagesc(angle(mat.image.grappa.wash_kellman)); colormap(gray);
subplot(2,5,3);  imagesc(abs(mat.image.grappa.wash_python));
subplot(2,5,4);  imagesc(angle(mat.image.grappa.wash_python)); colormap(gray);
subplot(2,5,5);  imagesc(abs(mat.image.grappa.inati_matlab));
subplot(2,5,6);  imagesc(angle(mat.image.grappa.inati_matlab)); colormap(gray);
subplot(2,5,7);  imagesc(m_siemens);
subplot(2,5,8);  imagesc(p_siemens); colormap(gray);
subplot(2,5,9);  imagesc(abs(mat.image.grappa.inati_iter_python));
subplot(2,5,10);  imagesc(angle(mat.image.grappa.inati_iter_python)); colormap(gray);
